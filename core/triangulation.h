...
public:
Triangulation() : nodes_(4), flag_(4), currentflag_(4,0), allowSelfAdjacency_(false), allow_degeneracy_(false), spanning_tree_(true), dual_spanning_tree_(true), middle_graph_(true),next_inactive_graph_ind_(0), mid_graph_(ABSMAX_DC),graph_nodes_(ABSMAX_DC),inactive_graph_nodes_(ABSMAX_DC),middle_graph_size_(0),num_connected_(0), coord_2_nodes_(0),coord_2_edges_(0),coord_3_nodes_(0) {}
